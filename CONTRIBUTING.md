...
docs/              Built site (guide + skill zip), generated by guide/build.py — git-ignored; built by Cloudflare on deploy
...
```bash
python guide/build.py   # → docs/index.html + docs/fitness-tracker.zip
```
